...
def get_args():
    ...
    ######################## loss settings ########################
    parser.add_argument("--loss_names", default='sdm+xpool+mlm+sdm2+itc', help="which loss to use ['mlm', 'itc', 'sdm2', 'cmpm', 'sdm', 'xpool','cfine','LLM']")
    ...
    parser.add_argument("--root_dir", default="/home/hpc/LAB-data/disk-4T/syc_data/irra-vpt-acm/irra-v1/irra/IRRA-main_v2/data/")
